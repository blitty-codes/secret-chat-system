...
## Requisitos Básicos
	...
	- [x] RSIS0: El sistema estará desarrollado en C, C++, Rust o Python.
	- [x] RSIS1: El sistema necesitará tener un cifrado asimétrico.
	...
	- [x] RS1: El servidor tendrá su propio logger, donde se encuentren todos los movimientos.
	...
	- [x] RS4: El servidor tendrá una configuración por defecto.
	...
	- [x] RC2: Las personas, una vez abren su cliente, tendrán un menú con diferentes opciones.
		- [x] R2.0: Permitirá añadir nuevos servidores.
		- [x] R2.1: Permitirá usar un servidor.
		- [x] R2.2: Permitirá escoger un servidor como predeterminado.
	- [x] RC3: El usuario podrá volver al menú con una combinación de teclas.
	- [x] RC4: El cliente tendrá un banner en ASCII cada vez que se abra el software.
	- [x] RC5: Toda configuración del cliente será guardada en un fichero de configuración.
	- [x] RC6: El cliente debe tener un fichero de configuración por defecto.
